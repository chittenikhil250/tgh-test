...
$(document).ready(function($) {
	...
	var fenway = [17.4389244,78.4507648]; //Change a map coordinate here!
	var markerPosition = [17.4389244,78.4507648]; //Change a map marker here!
	$('.map')
		.gmap3({
			center:fenway,
			zoom: 14,
